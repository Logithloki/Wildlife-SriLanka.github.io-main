...
fetch('data.json')
  ...
  .then(data => {
    ...
    display_text(data.title_7,"title");

    
    display_text(data.sections_yala[0].title,"Yala_Heading");
    display_text(data.subtitle,"Sub");


    display_text(data.sections_yala[0].sections[0].title,"Welcome");
    display_text(data.sections_yala[0].sections[0].description,"Welcome_des");

    display_text(data.sections_yala[0].sections[1].title,"about");
    display_text(data.sections_yala[0].sections[1].description,"about_des");

    display_text(data.sections_yala[0].sections[2].title,"BW");
    display_text(data.sections_yala[0].sections[2].description,"Bird_des");

    display_text(data.sections_yala[0].sections[3].title,"LST");
    display_text(data.sections_yala[0].sections[3].description,"Tour_des");

    display_text(data.sections_yala[0].sections[4].title,"Yala");
    display_text(data.sections_yala[0].sections[4].description,"Yala_des");
